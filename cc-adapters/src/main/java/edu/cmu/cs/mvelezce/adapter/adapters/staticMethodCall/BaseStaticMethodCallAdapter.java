package edu.cmu.cs.mvelezce.adapter.adapters.staticMethodCall;
...
public class BaseStaticMethodCallAdapter extends BaseAdapter {
  ...
  public static final String PROGRAM_NAME = "staticMethodCall";
  public static final String MAIN_CLASS = "edu.cmu.cs.mvelezce.analysis.StaticMethodCall";
  ...
  public BaseStaticMethodCallAdapter() {
