package edu.cmu.cs.mvelezce.evaluation.approaches.splatdelay.execute.adapter.prevalyer;
...
public class SPLatDelayPrevaylerDelayMain extends SPLatDelayMain {

    public SPLatDelayPrevaylerDelayMain(String programName) {
        super(programName);
    }
