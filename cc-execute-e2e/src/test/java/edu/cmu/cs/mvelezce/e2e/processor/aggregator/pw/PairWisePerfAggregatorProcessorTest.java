...
public class PairWisePerfAggregatorProcessorTest {

  @Test
  public void berkeleyDB() throws IOException, InterruptedException {
    String programName = BaseMeasureDiskOrderedScanAdapter.PROGRAM_NAME;
    BaseExecutor<ProcessedPerfExecution> executor = new PairWiseExecutor(programName);
    ...
    Analysis perfAggregatorProcessor =
        new PairWisePerfAggregatorProcessor(programName, itersToResults);
