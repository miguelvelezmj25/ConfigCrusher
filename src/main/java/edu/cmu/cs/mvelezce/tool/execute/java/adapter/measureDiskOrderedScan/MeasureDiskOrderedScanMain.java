...
public class MeasureDiskOrderedScanMain extends BaseMain {

  static final String MEASURE_DISK_ORDERED_SCAN_MAIN = MeasureDiskOrderedScanMain.class
      .getCanonicalName();

  private MeasureDiskOrderedScanMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new MeasureDiskOrderedScanMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new MeasureDiskOrderedScanAdapter();
