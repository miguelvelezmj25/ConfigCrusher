...
public class SimpleForExample4Main extends BaseMain {

  static final String SIMPLE_FOR_EXAMPLE_4_MAIN = SimpleForExample4Main.class.getCanonicalName();

  private SimpleForExample4Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new SimpleForExample4Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new SimpleForExample4Adapter();
