...
import edu.cmu.cs.mvelezce.blackbox.processor.aggregator.gt.GroundTruthPerfAggregatorProcessor;
...
public class GroundTruthPerformanceModelBuilderTest {
  ...
  public void berkeleyDB() throws IOException, InterruptedException {
    ...
    BasePerformanceModelBuilder builder =
        new GroundTruthPerformanceModelBuilder(programName, options, performanceEntries);
