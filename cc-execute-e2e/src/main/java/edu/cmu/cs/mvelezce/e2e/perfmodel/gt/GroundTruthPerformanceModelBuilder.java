package edu.cmu.cs.mvelezce.e2e.perfmodel.gt;
...
public class GroundTruthPerformanceModelBuilder extends E2EPerformanceModelBuilder {

  private static final String OUTPUT_DIR =
      "../cc-execute-e2e/" + Options.DIRECTORY + "/model/java/programs/gt";
