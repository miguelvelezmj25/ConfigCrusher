...
public class SubtracesMain extends BaseMain {

  static final String SUBTRACES_MAIN = SubtracesMain.class.getCanonicalName();

  private SubtracesMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new SubtracesMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new SubtracesAdapter();
