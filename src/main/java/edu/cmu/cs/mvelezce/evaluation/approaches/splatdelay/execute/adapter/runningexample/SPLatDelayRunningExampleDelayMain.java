package edu.cmu.cs.mvelezce.evaluation.approaches.splatdelay.execute.adapter.runningexample;
...
public class SPLatDelayRunningExampleDelayMain extends SPLatDelayMain {

    public SPLatDelayRunningExampleDelayMain(String programName) {
        super(programName);
    }
