...
public class Subtraces7Main extends BaseMain {

  static final String SUBTRACES_7_MAIN = Subtraces7Main.class.getCanonicalName();

  private Subtraces7Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new Subtraces7Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new Subtraces7Adapter();
