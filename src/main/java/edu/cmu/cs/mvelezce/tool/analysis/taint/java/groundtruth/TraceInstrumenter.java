...
//  public TraceInstrumenter(String pathToClasses)
...
//  }
  ...
  public void transformMethod(MethodNode methodNode, ClassNode classNode) {
    ...
    ListIterator<AbstractInsnNode> insnIter = insnList.iterator();
    ...
    while (insnIter.hasNext()) {
      ...
      if (opcode >= Opcodes.IFEQ && opcode <= Opcodes.IF_ACMPNE) {
        insnList.insertBefore(insnNode, new InsnNode(Opcodes.NOP));
      }
    }
