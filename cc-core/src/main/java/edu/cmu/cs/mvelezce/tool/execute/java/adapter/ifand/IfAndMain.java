...
public class IfAndMain extends BaseMain {

  static final String IF_AND_MAIN = IfAndMain.class.getCanonicalName();

  private IfAndMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new IfAndMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new IfAndAdapter();
