...
public class SimpleForExample3Main extends BaseMain {

  static final String SIMPLE_FOR_EXAMPLE_3_MAIN = SimpleForExample3Main.class.getCanonicalName();

  private SimpleForExample3Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new SimpleForExample3Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new SimpleForExample3Adapter();
