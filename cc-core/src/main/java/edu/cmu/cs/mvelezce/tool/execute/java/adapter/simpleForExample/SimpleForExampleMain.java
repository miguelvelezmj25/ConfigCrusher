...
public class SimpleForExampleMain extends BaseMain {

  static final String SIMPLE_FOR_EXAMPLE_MAIN = SimpleForExampleMain.class.getCanonicalName();

  private SimpleForExampleMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new SimpleForExampleMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new SimpleForExampleAdapter();
