package edu.cmu.cs.mvelezce.tool.execute.java.adapter.orContext2;
...
public class OrContext2Main extends BaseMain {

  static final String OR_CONTEXT_2_MAIN = OrContext2Main.class.getCanonicalName();

  private OrContext2Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new OrContext2Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new OrContext2Adapter();
