...
public class MultiFacetsMain extends BaseMain {

  static final String MULTI_FACETS_MAIN = MultiFacetsMain.class.getCanonicalName();

  private MultiFacetsMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new MultiFacetsMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new MultiFacetsAdapter();
