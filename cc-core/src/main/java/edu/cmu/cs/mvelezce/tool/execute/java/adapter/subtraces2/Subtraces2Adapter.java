...
public class Subtraces2Adapter extends BaseAdapter {
  ...
  public Subtraces2Adapter() {
    // TODO check that we are passing empty string
    super(Subtraces2Adapter.PROGRAM_NAME, Subtraces2Adapter.MAIN_CLASS, "",
        Subtraces2Adapter.getListOfOptions());
  }

  // TODO abstract method in base adapter?
  public static List<String> getListOfOptions() {
    return Arrays.asList(Subtraces2Adapter.OPTIONS);
  }
  ...
  public void execute(Set<String> configuration, int iteration)
    ...
    this.execute(Subtraces2Main.SUBTRACES_2_MAIN, newArgs);
  }
}
