...
public class IfOrMain extends BaseMain {

  static final String IF_OR_MAIN = IfOrMain.class.getCanonicalName();

  private IfOrMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new IfOrMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new IfOrAdapter();
