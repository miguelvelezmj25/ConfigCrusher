...
public class OrContext2Adapter extends BaseAdapter {
  ...
  public OrContext2Adapter() {
    // TODO check why we are passing empty string
    super(OrContext2Adapter.PROGRAM_NAME, OrContext2Adapter.MAIN_CLASS, "",
        OrContext2Adapter.getListOfOptions());
  }

  public static List<String> getListOfOptions() {
    return Arrays.asList(OrContext2Adapter.OPTIONS);
  }
  ...
  public void execute(Set<String> configuration, int iteration)
    ...
    this.execute(OrContext2Main.OR_CONTEXT_2_MAIN, newArgs);
  }
}
