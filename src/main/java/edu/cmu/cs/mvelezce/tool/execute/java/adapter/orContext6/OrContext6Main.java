...
public class OrContext6Main extends BaseMain {

  static final String OR_CONTEXT_6_MAIN = OrContext6Main.class.getCanonicalName();

  private OrContext6Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new OrContext6Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new OrContext6Adapter();
