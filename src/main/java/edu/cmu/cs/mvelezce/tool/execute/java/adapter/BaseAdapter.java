...
public abstract class BaseAdapter implements Adapter {
    ...
    public BaseAdapter(String programName, String mainClass, String directory) {
    ...
    public static String executeJavaProgram(String programName, String mainAdapter, String mainClass, String directory, String args) {
        String command = "java -Xmx8G -cp " + BaseAdapter.CLASS_CONTAINER + ":" + BaseAdapter.JACKSON_PATH + ":" + BaseAdapter.JSON_SIMPLE_PATH + ":" + directory + " " + mainAdapter + " " + programName + " " + mainClass + " " + args;
