package edu.cmu.cs.mvelezce.tool.execute.java.adapter.phosphorExample3;
...
public class PhosphorExample3Main extends BaseMain {

  static final String PHOSPHOR_EXAMPLE_3_MAIN = PhosphorExample3Main.class
      .getCanonicalName();

  private PhosphorExample3Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new PhosphorExample3Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new PhosphorExample3Adapter();
