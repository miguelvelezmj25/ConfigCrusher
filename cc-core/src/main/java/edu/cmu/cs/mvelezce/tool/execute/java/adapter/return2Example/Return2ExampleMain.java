...
public class Return2ExampleMain extends BaseMain {

  static final String RETURN_2_EXAMPLE_MAIN = Return2ExampleMain.class.getCanonicalName();

  private Return2ExampleMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new Return2ExampleMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new Return2ExampleAdapter();
