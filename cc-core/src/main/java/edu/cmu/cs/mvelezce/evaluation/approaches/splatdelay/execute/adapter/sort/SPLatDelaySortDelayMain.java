package edu.cmu.cs.mvelezce.evaluation.approaches.splatdelay.execute.adapter.sort;
...
public class SPLatDelaySortDelayMain extends SPLatDelayMain {

    public SPLatDelaySortDelayMain(String programName) {
        super(programName);
    }
