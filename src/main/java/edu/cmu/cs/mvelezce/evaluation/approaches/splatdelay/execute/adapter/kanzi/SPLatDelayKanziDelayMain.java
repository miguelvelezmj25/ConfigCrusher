package edu.cmu.cs.mvelezce.evaluation.approaches.splatdelay.execute.adapter.kanzi;
...
public class SPLatDelayKanziDelayMain extends SPLatDelayMain {

    public SPLatDelayKanziDelayMain(String programName) {
        super(programName);
    }
