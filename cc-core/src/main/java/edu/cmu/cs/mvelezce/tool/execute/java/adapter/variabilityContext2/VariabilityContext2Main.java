...
public class VariabilityContext2Main extends BaseMain {

  static final String VARIABILITY_CONTEXT_2_MAIN = VariabilityContext2Main.class.getCanonicalName();

  private VariabilityContext2Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new VariabilityContext2Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new VariabilityContext2Adapter();
