...
public class Implicit2Main extends BaseMain {

  static final String IMPLICIT_2_MAIN = Implicit2Main.class.getCanonicalName();

  private Implicit2Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new Implicit2Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new Implicit2Adapter();
