...
public class BruteForceInstrumentExecutorTest {
  ...
  public void berkeleyDb() throws IOException, InterruptedException {
    ...
    Executor executor = new BruteForceInstrumentExecutor(programName, configs, 30000);
  ...
  public void lucene() throws IOException, InterruptedException {
    ...
    String[] args = new String[0];
    Set<Set<String>> configs = compression.analyze(args);
    Executor executor = new BruteForceInstrumentExecutor(programName, configs, 3000);
