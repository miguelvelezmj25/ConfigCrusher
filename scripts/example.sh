...
function run {
    ...
    java -cp \
      $cc:$m2/commons-io/commons-io/2.6/commons-io-2.6.jar:$m2/org/apache/commons/commons-math3/3.6.1/commons-math3-3.6.1.jar:$m2/commons-cli/commons-cli/1.4/commons-cli-1.4.jar:$m2/com/fasterxml/jackson/core/jackson-core/2.9.7/jackson-core-2.9.7.jar \
