...
public class Subtraces6Adapter extends BaseAdapter {
  ...
  public Subtraces6Adapter() {
    // TODO check that we are passing empty string
    super(Subtraces6Adapter.PROGRAM_NAME, Subtraces6Adapter.MAIN_CLASS, "",
        Subtraces6Adapter.getListOfOptions());
  }

  // TODO abstract method in base adapter?
  public static List<String> getListOfOptions() {
    return Arrays.asList(Subtraces6Adapter.OPTIONS);
  }
  ...
  public void execute(Set<String> configuration, int iteration)
    ...
    this.execute(Subtraces6Main.SUBTRACES_6_MAIN, newArgs);
  }
}
