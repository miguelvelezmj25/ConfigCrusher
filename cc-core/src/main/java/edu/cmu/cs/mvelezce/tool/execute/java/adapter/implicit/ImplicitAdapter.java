...
public class ImplicitAdapter extends BaseAdapter {
  ...
  public ImplicitAdapter() {
    // TODO check that we are passing empty string
    super(ImplicitAdapter.PROGRAM_NAME, ImplicitAdapter.MAIN_CLASS, "",
        ImplicitAdapter.getListOfOptions());
  }

  public static List<String> getListOfOptions() {
    return Arrays.asList(ImplicitAdapter.OPTIONS);
  }
  ...
  public void execute(Set<String> configuration, int iteration)
    ...
    this.execute(ImplicitMain.IMPLICIT_MAIN, newArgs);
  }
}
