...
public class PairWiseInstrumentExecutor extends E2EInstrumentExecutor {

  public static final String OUTPUT_DIR = E2EInstrumentExecutor.OUTPUT_DIR + "/java/programs/pw";

  public PairWiseInstrumentExecutor(String programName) {
    this(programName, new HashSet<>(), -1);
  }

  PairWiseInstrumentExecutor(
