...
public class SimpleForExample6Main extends BaseMain {

  static final String SIMPLE_FOR_EXAMPLE_6_MAIN = SimpleForExample6Main.class.getCanonicalName();

  private SimpleForExample6Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new SimpleForExample6Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new SimpleForExample6Adapter();
