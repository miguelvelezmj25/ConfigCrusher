...
public class SimpleExample1Main extends BaseMain {

  static final String SIMPLE_EXAMPLE_1_MAIN = SimpleExample1Main.class.getCanonicalName();

  private SimpleExample1Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new SimpleExample1Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new SimpleExample1Adapter();
