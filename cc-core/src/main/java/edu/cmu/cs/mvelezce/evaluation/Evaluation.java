...
public class Evaluation {
  ...
  double getTotalSamplingTime(String approach) throws IOException {
    double time = 0.0;

    File file = this.getFile(approach);
  ...
  private File deleteOutputFile(String approach1, String approach2, boolean all)
      throws IOException {
  ...
  public void compareApproaches(String approach1, String approach2, boolean all)
      throws IOException {
