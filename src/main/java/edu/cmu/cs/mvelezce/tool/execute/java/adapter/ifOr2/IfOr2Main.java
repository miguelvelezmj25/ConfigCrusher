...
public class IfOr2Main extends BaseMain {

  static final String IF_OR_2_MAIN = IfOr2Main.class.getCanonicalName();

  private IfOr2Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new IfOr2Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new IfOr2Adapter();
