...
public class PhosphorExample6Main extends BaseMain {

  static final String PHOSPHOR_EXAMPLE_6_MAIN = PhosphorExample6Main.class
      .getCanonicalName();

  private PhosphorExample6Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new PhosphorExample6Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new PhosphorExample6Adapter();
