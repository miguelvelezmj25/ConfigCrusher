...
public class VariabilityContext1Main extends BaseMain {

  static final String VARIABILITY_CONTEXT_1_MAIN = VariabilityContext1Main.class.getCanonicalName();

  private VariabilityContext1Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new VariabilityContext1Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new VariabilityContext1Adapter();
