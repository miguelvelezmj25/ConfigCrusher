...
public class E2ERealTimeExecutionParser extends E2ETimeExecutionParser {

  public E2ERealTimeExecutionParser(String programName, String outputDir) {
  ...
  protected PerfExecution readFromFile(File file) throws IOException {
    ...
    return new PerfExecution(
        e2eTimePerfExecution.getConfiguration(), e2eTimePerfExecution.getRegionsToPerf());
  }
}
