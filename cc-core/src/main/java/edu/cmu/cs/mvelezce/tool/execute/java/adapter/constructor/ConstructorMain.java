...
public class ConstructorMain extends BaseMain {

  static final String CONSTRUCTOR_MAIN = ConstructorMain.class.getCanonicalName();

  private ConstructorMain(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new ConstructorMain(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new ConstructorAdapter();
