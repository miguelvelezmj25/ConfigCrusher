...
public class Subtraces5Main extends BaseMain {

  static final String SUBTRACES_5_MAIN = Subtraces5Main.class.getCanonicalName();

  private Subtraces5Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new Subtraces5Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new Subtraces5Adapter();
