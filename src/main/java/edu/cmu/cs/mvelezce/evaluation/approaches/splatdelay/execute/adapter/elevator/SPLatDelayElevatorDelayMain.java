package edu.cmu.cs.mvelezce.evaluation.approaches.splatdelay.execute.adapter.elevator;
...
public class SPLatDelayElevatorDelayMain extends SPLatDelayMain {

    public SPLatDelayElevatorDelayMain(String programName) {
        super(programName);
    }
