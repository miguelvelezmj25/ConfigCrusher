...
public class PhosphorExample2Main extends BaseMain {

  static final String PHOSPHOR_EXAMPLE_2_MAIN = PhosphorExample2Main.class
      .getCanonicalName();

  private PhosphorExample2Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new PhosphorExample2Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new PhosphorExample2Adapter();
