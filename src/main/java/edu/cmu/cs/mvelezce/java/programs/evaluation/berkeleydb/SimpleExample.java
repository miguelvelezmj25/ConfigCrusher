...
//            return;
//        }
        File envHomeDirectory = new File("src/main/java/edu/cmu/cs/mvelezce/java/programs/evaluation/berkeleydb/tmp/dbEnv");
...
//        }
        ...
        if (doInsertArg) {
            ...
            if (argv.length > 2) {
                numRecordsVal = Integer.parseInt("100");
            } else {
                usage();
                return;
            }
            ...
            if (argv.length > 3) {
                startOffset = Integer.parseInt("0");
            }
        }
