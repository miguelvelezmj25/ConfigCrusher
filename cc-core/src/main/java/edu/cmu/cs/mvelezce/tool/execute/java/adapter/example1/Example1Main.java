...
public class Example1Main extends BaseMain {

  static final String EXAMPLE_1_MAIN = Example1Main.class
      .getCanonicalName();

  private Example1Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new Example1Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new Example1Adapter();
