 ...
 */
public class StaticTimerInstrumenterTest {
...
//    String[] args = new String[0];
    ...
    protected void compile() throws IOException, InterruptedException {
        Instrumenter compiler = new CompileInstrumenter(StaticTimerInstrumenterTest.srcDir, StaticTimerInstrumenterTest.classDir);
        compiler.compile();
    }
...
//    }
    ...
    protected void format() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, IOException, InterruptedException {
        ...
        Instrumenter compiler = new Formatter(StaticTimerInstrumenterTest.srcDir, StaticTimerInstrumenterTest.classDir);
...
//    }
    ...
    public void runningExample() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/running-example";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/running-example/target/classes";
...
//        args[0] = "-saveres";
        ...
        Instrumenter instrumenter = new ConfigCrusherTimerRegionInstrumenter(programName, entry, StaticTimerInstrumenterTest.classDir, decisionsToOptions);
        instrumenter.instrument(args);
    }
    ...
    public void graph0() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/dummy/";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/dummy/out/production/dummy";
...
//        args[0] = "-saveres";
    ...
    public void optimizer() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic-optimizer";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/pngtastic-optimizer/out/production/pngtastic-optimizer";
...
//        args[0] = "-saveres";
    ...
    public void jrip() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/jrip";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/jrip/target/classes";
...
//        args[0] = "-saveres";
    ...
    public void prevayler() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/prevayler";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/prevayler/target/classes";
...
//        args[0] = "-saveres";
    ...
    public void kanzi() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/kanzi";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/kanzi/target/classes";
...
//        args[0] = "-saveres";
    ...
    public void grep() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/grep";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/grep/target/classes";
...
//        args[0] = "-saveres";
    ...
    public void density() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/density";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/density/target/classes";
...
//        args[0] = "-saveres";
    ...
    public void email() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/email";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/email/target/classes";
...
//        args[0] = "-saveres";
    ...
    public void sort() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InterruptedException {
        ...
        StaticTimerInstrumenterTest.srcDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/sort";
        StaticTimerInstrumenterTest.classDir = BaseAdapter.USER_HOME + "/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/sort/target/classes";
