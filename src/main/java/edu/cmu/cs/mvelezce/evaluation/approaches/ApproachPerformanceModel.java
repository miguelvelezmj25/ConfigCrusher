...
public abstract class ApproachPerformanceModel extends PerformanceModel {

    protected static Map<Region, Map<Set<String>, Long>> toNanosecondPerformance(Map<Region, Map<Set<String>, Double>> regionsToPerformanceTables) {
