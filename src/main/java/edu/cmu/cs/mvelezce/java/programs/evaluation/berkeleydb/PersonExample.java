...
public class PersonExample {
    ...
    public static void main(String[] args) throws DatabaseException {
        ...
        if (args.length != 2 || !"-h".equals(args[0])) {
            System.err.println("Usage: java " + PersonExample.class.getName() + " -h <envHome>");
            System.exit(2);
        }
        PersonExample example = new PersonExample(new File("src/main/java/edu/cmu/cs/mvelezce/java/programs/evaluation/berkeleydb/tmp/dbEnv"));
        example.run();
        example.close();
    }
