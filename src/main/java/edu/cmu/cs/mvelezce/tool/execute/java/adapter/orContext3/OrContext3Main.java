...
public class OrContext3Main extends BaseMain {

  static final String OR_CONTEXT_3_MAIN = OrContext3Main.class.getCanonicalName();

  private OrContext3Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new OrContext3Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new OrContext3Adapter();
