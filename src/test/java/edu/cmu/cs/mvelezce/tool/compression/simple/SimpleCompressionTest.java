...
public class SimpleCompressionTest {
  ...
  public static void checktOptionsPermuatationsToGetConfigurationsToExecute(
      Set<Set<String>> relevantOptionsSet) {
...
//                    System.out.println("Want configuration: " + configuration + " from: " + relevantOptionsConvenient);
  ...
  public static boolean matches(Set<String> result, Set<String> configuration,
      Set<String> relevantOptions) {
  ...
  public void testGetConfigurationsToExecutePipeline14() throws IOException {
    ...
    // Options
    Set<Set<String>> relevantOptionsSet = BaseCompressionTest
        .getOptionsSet("AB, AC, AD, BC, CD, BD");
