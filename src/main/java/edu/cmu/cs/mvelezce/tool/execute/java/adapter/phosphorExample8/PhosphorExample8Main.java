...
public class PhosphorExample8Main extends BaseMain {

  static final String PHOSPHOR_EXAMPLE_8_MAIN = PhosphorExample8Main.class
      .getCanonicalName();

  private PhosphorExample8Main(String programName, String iteration, String[] args) {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Main main = new PhosphorExample8Main(programName, iteration, sleepArgs);
  ...
  public void logExecution() throws IOException {
    Adapter adapter = new PhosphorExample8Adapter();
