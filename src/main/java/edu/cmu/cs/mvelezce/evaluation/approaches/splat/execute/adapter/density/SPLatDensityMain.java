package edu.cmu.cs.mvelezce.evaluation.approaches.splat.execute.adapter.density;
...
public class SPLatDensityMain extends SPLatMain {

    public SPLatDensityMain(String programName) {
        super(programName);
    }
